...
from helical.models.helix_mrna_generator.model.configuration_helix import HelixmRNAConfig as HelixmRNAPretrainedConfig
...
class HelixmRNAForCausalLM(HelixmRNAPretrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.backbone = HelixmRNAPretrainedModel(config)
